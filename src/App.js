...
const FEEDBACK_PROMPT = (mode, essayPrompt) => {
  const modeConfig = {
    standard: {
      rigor: "moderate",
    ...
    try {
      ...
      const res = await axios.post(
        'https://api.groq.com/openai/v1/chat/completions',
        {
          ...
          messages: [
            { role: 'system', content: FEEDBACK_PROMPT(selectedMode, essayPrompt) },
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
              Transform Your Essay
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Get detailed, actionable feedback from our expert AI that analyzes every aspect of your college essay
            </p>
          </div>
          ...
          {feedback && (
            <div className="w-full">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Your Essay Analysis</h2>
                <p className="text-gray-600">Detailed feedback on every aspect of your essay</p>
              </div>
